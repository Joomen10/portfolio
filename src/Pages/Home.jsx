...
const WORDS = ["New York University Student", "Data Enthusiast", "Software Developer"];
const TECH_STACK = ["Python", "SQL", "Machine Learning", "Tableau"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Joomen10" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/chris-jy-park/" },
  { icon: Instagram, link: "https://www.instagram.com/chris.pkk" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Christopher Park, a Student at New York University majoring in Data Science & Computer Science
                </p>
